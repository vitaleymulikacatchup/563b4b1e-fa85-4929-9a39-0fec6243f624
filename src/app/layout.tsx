...
export const metadata: Metadata = {
  title: "Mecho - Fine Dining Restaurant | Authentic Flavors",
  description: "Experience exceptional cuisine at Mecho restaurant. Fresh ingredients, expert chefs, and warm atmosphere create unforgettable dining moments.",
  keywords: "fine dining, restaurant, authentic cuisine, fresh ingredients, reservations, gourmet food",
  openGraph: {
    title: "Mecho - Fine Dining Restaurant",
    description: "Experience exceptional cuisine at Mecho restaurant. Fresh ingredients, expert chefs, and warm atmosphere.",
    siteName: "Mecho Restaurant",
    images: [
      {
        url: "https://images.pexels.com/photos/34450955/pexels-photo-34450955.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "Mecho restaurant interior"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Mecho - Fine Dining Restaurant",
    description: "Experience exceptional cuisine at Mecho restaurant.",
